...
class Route {
    ...
    const ROUTE = [
        ...
        'order@createall' => ['OrderController', 'createall'],
        'order@createallsave' => ['OrderController', 'createallsave'],
        'order@buyallview' => ['OrderController', 'buyallview'],
        'order@buyall' => ['OrderController', 'buyall'],
...
//        'buy@index' => ['BuyallController', 'index'],
        ...
        'invoice@show' => ['InvoiceController', 'show'],
