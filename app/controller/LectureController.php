...
class LectureController extends BaseController  {
    ...
    public function show($course_id){
        ...
        $lectlist = LecturesList::getWere("course_id = $course_id");
		    ...
		    $lecture[$key]->video_ID=str_replace('https://www.youtube.com/embed/','',$lecture[$key]->video_url);
                }
            }else{
                $lecture[0] = Lecture::getWere("ID = $lectlist->lecture_id");
                $lecture[0]->order = $lectlist->order_num;
 		$lecture[0]->video_ID=str_replace('https://www.youtube.com/embed/','',$lecture[0]->video_url);
            }
