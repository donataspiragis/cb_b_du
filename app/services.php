...
return function(ContainerConfigurator $configurator) {
    $configurator->parameters()
        ...
        ->set('paysera.accepturl', 'http://localhost/cb_b_du/public/order/answer')
        ->set('paysera.cancelurl', 'http://localhost/cb_b_du/public/order/cancelPaysera')
        ->set('paysera.callbackurl', 'http://localhost/cb_b_du/public/callbackpaysera')
